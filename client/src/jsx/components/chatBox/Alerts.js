           ...
           <ul className="contacts">
             ...
             <li className="active">
               <div className="d-flex bd-highlight">
                 <div className="img_cont primary">GB</div>
                 <div className="user_info">
                   <span>Guy Bader Birthday</span>
             ...
             <li>
               <div className="d-flex bd-highlight">
                 <div className="img_cont success">AZ</div>
                 <div className="user_info">
                   <span>Perfection Simplified</span>
                   <p>Adir Zoaretz commented on your status</p>
                 </div>
               </div>
             </li>
             <li className="name-first-letter">SEVER STATUS</li>
             <li>
               <div className="d-flex bd-highlight">
                 <div className="img_cont primary">MR</div>
                 <div className="user_info">
                   <span>Miri Revivo</span>
                   <p>Miri is online</p>
                 </div>
               </div>
             </li>
             <li>
               <div className="d-flex bd-highlight">
                 <div className="img_cont info">AB</div>
                 <div className="user_info">
                   <span>Adi Ben Hayun</span>
                   <p>Adi left 30 mins ago</p>
                 </div>
               </div>
             </li>
           </ul>

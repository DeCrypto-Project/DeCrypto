		...
		return(
			<Fragment>
				...
				>
					...
					<strong>{"Hi There!"}</strong> {"first time? Let's get you started."}
					...
					<div className="col-xl-9 col-xxl-8">
						<div className="card">
							<div className="card-header border-0 flex-wrap pb-0 select-btn">
								...
								<Dropdown>
									<Dropdown.Toggle variant="" className="form-control style-1  btn-secondary default-select">{crrency1}</Dropdown.Toggle>
									<Dropdown.Menu>
								...
								<div className="card">
									<div className="card-header d-sm-flex d-block pb-0 border-0">
										...
										<Dropdown className="custom-dropdown d-block mt-3 mt-sm-0 mb-0">
											<Dropdown.Toggle variant="" className="btn btn-light btn-sm d-flex align-items-center svg-btn i-false" data-toggle="dropdown">

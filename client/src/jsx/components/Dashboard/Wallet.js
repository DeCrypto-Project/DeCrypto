  ...
  return (
    <Fragment>
      <div className="form-head mb-sm-5 mb-3 d-flex align-items-center flex-wrap">
        ...
        <Link to={"#"} className="btn btn-outline-secondary mr-3 mb-2">
          <i className="las la-calendar scale5 mr-2"></i>Filter Periode
        </Link>
            ...
            <div className="col-xl-12">
              <div className="d-block d-sm-flex mb-4">
                ...
                <div className="d-flex mt-sm-0">
                  <Link to={"#"} className="btn-link mr-3 underline">
                    Generate Number
                  </Link>

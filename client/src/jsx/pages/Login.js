            ...
            <div className="login-wrapper">
                <div className="login-aside-left" style={{backgroundImage:"url("+ login +")"}}>
                    ...
                    <div className="login-description">
                        ...
                        <p className="fs-12 text-dark">We take care of all the heavy lifting so that you can sit back, relax, and watch your portfolio grow!</p>
                        ...
                        <div className="mt-5">
                            ...
                            <Link to={"#"} className="text-black">© 2022 Decryto</Link>
                        </div>
                    </div>
                </div>
                          ...
                          <div className="row no-gutters">
                            <div className="col-xl-12">
                              <div className="auth-form-1">
                                <div className="mb-4">
                                    <h3 className="text-primary mb-1">Welcome to Decrypto</h3>
